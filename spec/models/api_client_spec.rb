...
describe ApiClient do
  ...
  describe "#api" do
    it "#api uses #github_token to auth requests" do
      ...
      stub_request(:get, "https://api.github.com/user").
        with(:headers => {'Accept'=>'application/vnd.github.v3+json', 'Accept-Encoding'=>'gzip;q=1.0,deflate;q=0.6,identity;q=0.3', 'Authorization'=>'token secret', 'User-Agent'=>'Octokit Ruby Gem 3.3.0'}).
  ...
  describe "#oauth_client_api" do
    ...
    stub_request(:get, "https://api.github.com/meta?client_id=id&client_secret=secret").
      with(:headers => {'Accept'=>'application/vnd.github.v3+json', 'Accept-Encoding'=>'gzip;q=1.0,deflate;q=0.6,identity;q=0.3', 'User-Agent'=>'Octokit Ruby Gem 3.3.0'}).
